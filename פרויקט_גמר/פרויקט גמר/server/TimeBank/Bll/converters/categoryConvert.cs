   ...
   public class categoryConvert
    {
        ...
        public static Dto.dtoClasses.Category convertFromMicToDto(Dal.Models.Category microCategory)
        {
            ...
            retCategory.forGroup = microCategory.ForGroup;
            retCategory.minGroup = microCategory.MinGroup;
            retCategory.maxGroup = microCategory.MaxGroup;
        ...
        public static Dal.Models.Category convertFromDtoToMicro(Dto.dtoClasses.Category c)
        {
            ...
            microCategory.ForGroup  = c.forGroup;
            microCategory.MinGroup = c.minGroup;
            microCategory.MaxGroup  = c.maxGroup;
